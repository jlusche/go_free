namespace :import do
  task :events => :environment do
    csv_text = File.read('/Users/jennalusche/Desktop/museums_free_day.csv')
  ...
  task :events => :environment do
    ...
    csv.each do |row|
      ...
      location = Location.find_by_name(hash['name_of_library'])

      unless location
        Location.create!({name: hash['name of library'] address: hash['name of address']})
      end
